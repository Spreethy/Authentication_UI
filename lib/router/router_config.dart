...
import 'package:authentication_ui/screens/forgetpassword.dart';
...
import 'package:authentication_ui/screens/register_page.dart';
import 'package:authentication_ui/screens/splash_screen.dart';
...
final router = GoRouter(routes: [
  ...
  GoRoute(
    ...
    pageBuilder: (context, state) {
      return const CupertinoPage(child: NewPasswordPage(email: '',));
    },
  ),
  GoRoute(
